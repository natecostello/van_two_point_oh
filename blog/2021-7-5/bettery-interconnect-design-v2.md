...
TODO: Link to previous, edit previous, and link it to this one.
...
_The parallel interconnects looks something like this except the bend is more triangular._
...
These will run ~11.5C over ambient at 0.5C charge or dischage rates.
...
This all led us to:
- Flat parallel bars that are 79.5 mm center-to-center that will be ~71 mm center-to-center with a 3/8 inch radius arch formed.
