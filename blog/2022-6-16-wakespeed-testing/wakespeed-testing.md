...
Idle thermal performance is still undetermined and will be tested in the future.  Initial testing suggest we can sustain about 4KW charge rates steady state while idling.

## Timeline

Note: This doesn't reflect full time effort.  Its sporadic and limited by other projects, family visits, and van availability.
